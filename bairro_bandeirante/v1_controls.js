...
"button": [
        {
            ...
            "height": 24,
            "id": "showTbButton",
            "onclick": function(){ if (!this.allowClick) return; this.allowClick = false; var tb = this.get('toolbar'); tb.setVisible(true); tb.style = 'transform-origin: 50% 100% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateX( 0deg ); background: rgba(0,0,0,0.5); transition: transform 500ms;'; tb.updateStyles(); var tt = this; setTimeout(function(){tt.setVisible(false); tt.get('hideTbButton').allowClick=true;},500); this.style = 'transform-origin: 50% 100% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateX( 90deg ); transition: transform 500ms;'; this.updateStyles(); var btn = this.get('galleryBtnPrev'); if (btn&&this.viewer.hasGallery){ btn.setVisible(true); btn.style = 'transform-origin: -30% 50% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateY( 90deg ); transition: transform 500ms;'; btn.updateStyles(); btn.tween({ 'delay': 0.01, 'time' : 0.01, 'onComplete' : function(a){ a.style = 'transform-origin: -30% 50% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateY( 0deg ); transition: transform 500ms;'; a.updateStyles(); } },true); }var btn = this.get('galleryBtnNext'); if (btn&&this.viewer.hasGallery){ btn.setVisible(true); btn.style = 'transform-origin: 130% 50% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateY( 90deg ); transition: transform 500ms;'; btn.updateStyles(); btn.tween({ 'delay': 0.01, 'time' : 0.01, 'onComplete' : function(a){ a.style = 'transform-origin: 130% 50% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateY( 0deg ); transition: transform 500ms;'; a.updateStyles(); } },true); }},
        ...
        },
        {
            ...
            "skin": "shadow(3,0,0,rgba(0,0,0,1));copy(defaultSkin,192,384,64,64,0,0,28,28);",
            "skinactive": "dim(-10px,-10px,48px,48px,48,48);comp(0.9);copy(defaultSkin,0,128,64,64,0,0,48,48);comp(1.0);shadow(3,0,0,rgba(0,0,0,1));copy(defaultSkin,192,384,64,64,10,10,28,28);",
            "skinhover": "dim(-10px,-10px,48px,48px,48,48);comp(0.5);copy(defaultSkin,0,128,64,64,0,0,48,48);comp(1.0);shadow(3,0,0,rgba(0,0,0,1));copy(defaultSkin,192,384,64,64,10,10,28,28)",
            "style": "transform-origin: -30% 50% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateY( 0deg ); transition: transform 500ms;",
            "visible": false,
            "width": 28,
            "xoff": 8,
            "yoff": -24
        },
        {
            ...
            "oninit": function(){ var g = this.viewer.gallery(); if ((!!g)&&g.length>1){ this.setVisible(true); } },
            "skin": "shadow(3,0,0,rgba(0,0,0,1));copy(defaultSkin,128,384,64,64,0,0,28,28);",
            "skinactive": "dim(-10px,-10px,48px,48px,48,48);comp(0.9);copy(defaultSkin,0,128,64,64,0,0,48,48);comp(1.0);shadow(3,0,0,rgba(0,0,0,1));copy(defaultSkin,128,384,64,64,10,10,28,28);",
            "skinhover": "dim(-10px,-10px,48px,48px,48,48);comp(0.5);copy(defaultSkin,0,128,64,64,0,0,48,48);comp(1.0);shadow(3,0,0,rgba(0,0,0,1));copy(defaultSkin,128,384,64,64,10,10,28,28)",
            "style": "transform-origin: 130% 50% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateY( 0deg ); transition: transform 500ms;",
            "visible": false,
            "width": 28,
            "xoff": 8,
            "yoff": -24
            ...
            "button": [
                {
                    ...
                    "id": "hideTbButton",
                    "index": 1,
                    "onclick": function(){ if (!this.allowClick) return; this.allowClick = false; var tb = this.get('toolbar'); tb.style = 'transform-origin: 50% 100% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateX( 90deg ); background: rgba(0,0,0,0.5); transition: transform 500ms;', tb.updateStyles(); var tt = this; var tbb = this.get('showTbButton'); setTimeout(function(){tb.setVisible(false); tbb.allowClick=true;},501); var tbb = this.get('showTbButton');  tbb.setVisible(true); tbb.style ='transform-origin: 50% 100% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateX( 90deg ); transition: transform 500ms;'; tbb.updateStyles();  tbb.tween({'delay': 0.01, 'time': 0.01, 'onComplete': function(a){ a.style ='transform-origin: 50% 100% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateX( 0deg ); transition: transform 500ms;'; a.updateStyles(); } },true);var btn = this.get('galleryBtnPrev'); if (btn&&this.viewer.hasGallery){ btn.style = 'transform-origin: -30% 50% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateY( 90deg ); transition: transform 500ms;'; btn.updateStyles(); btn.tween({ 'delay': 0.5, 'time' : 0.01, 'onComplete' : function(a){ a.setVisible(false); } },true); }var btn = this.get('galleryBtnNext'); if (btn&&this.viewer.hasGallery){ btn.style = 'transform-origin: 130% 50% 0px; transform: translate(0px,0px) translateZ(10000px) perspective( 800px ) rotateY( 90deg ); transition: transform 500ms;'; btn.updateStyles(); btn.tween({ 'delay': 0.5, 'time' : 0.01, 'onComplete' : function(a){ a.setVisible(false); } },true); }},
                ...
                },
                {
                    ...
                    "oninit": function(){var g = this.viewer.gallery(); if ((!!g) && g.length>1){ this.setVisible(true);}},
                    "priority": 3,
                    "skin": "shadow(3,0,0,rgba(0,0,0,1));copy(defaultSkin,128,320,64,64,0,0,28,28);",
                    "visible": false,
                    "xoff": 8,
                    "yoff": 0
                },
